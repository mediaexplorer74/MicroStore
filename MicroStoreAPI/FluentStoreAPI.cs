using MicroStoreAPI.Models;
using MicroStoreAPI.Models.Firebase;
using Flurl;
using Flurl.Http;
...
namespace MicroStoreAPI
{
    public class MicroStoreAPI
    {
        ...
        public MicroStoreAPI() { }
        public MicroStoreAPI(string token, string refreshToken)
        {
            Token = token;
